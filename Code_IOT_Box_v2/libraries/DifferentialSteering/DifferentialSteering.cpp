...
{
    float   nMotPremixL = 0;    // Motor (left)  premixed output        (-1000..+1000)
    float   nMotPremixR = 0;    // Motor (right) premixed output        (-1000..+1000)
    int     nPivSpeed = 0;      // Pivot Speed                          (-1000..+1000)
